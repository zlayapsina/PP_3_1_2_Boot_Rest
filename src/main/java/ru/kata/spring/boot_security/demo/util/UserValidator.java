...
import ru.kata.spring.boot_security.demo.service.UserValidateService;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        Optional<User> existingUser = userValidateService.findUserByUsername(user.getUsername());
